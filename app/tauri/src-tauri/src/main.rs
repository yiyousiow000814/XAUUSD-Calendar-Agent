...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::market_agent::inspect_market_agent_runtime,
            ...
            commands::market_agent::detect_system_profile,
            commands::market_agent::check_ollama_installed,
            commands::market_agent::check_ollama_running,
            commands::market_agent::list_ollama_models,
            commands::market_agent::recommend_local_model,
            commands::market_agent::detect_local_ai_setup,
            commands::market_agent::pull_ollama_model,
            commands::market_agent::cancel_model_download,
            commands::market_agent::test_llm_json,
            commands::market_agent::benchmark_llm,
            commands::market_agent::apply_llm_fallback_policy,
            ...
            commands::market_agent::ensure_market_agent_live_quote_stream,
            commands::market_agent::get_market_agent_live_quote,
            commands::market_agent::stop_market_agent_live_quote_stream,
            commands::market_agent::start_ctrader_connect,
            commands::market_agent::test_ctrader_backfill,
